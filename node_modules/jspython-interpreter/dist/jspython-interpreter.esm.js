...
var BinOpNode = /** @class */ (function (_super) {
    ...
    return BinOpNode;
}(AstNode));function parseDatetimeOrNull(value) {
    if (!value) {
        return null;
    }
...
var JspyError = /** @class */ (function (_super) {
    ...
    return JspyError;
}(Error));function cloneContext(context) {
    return {
...
var EvaluatorAsync = /** @class */ (function () {
    ...
    EvaluatorAsync.prototype.evalBlockAsync = function (ast, blockContext) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var lastResult, _loop_1, _i, _c, node, _d, _e, node, importNode, moduleAst, moduleBlockContext, scope, res, err_1, loc;
            var _this = this;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        if (!(node.type === 'import')) return [3 /*break*/, 4];
                        importNode = node;
                    ...
                    case 7:
                        _d++;
                        return [3 /*break*/, 1];
                    case 8: return [2 /*return*/, lastResult];
                }
            });
        });
    };
...
var Interpreter = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, evaluator
                                ...
                                var newContext = _this.assignLegacyImportContext(ast, scope);
    ...
    Interpreter.prototype.assignLegacyImportContext = function (ast, context) {
        ...
        var jsImport = importNodes
            .filter(function (im) { return !im.module.name.startsWith('/'); })
